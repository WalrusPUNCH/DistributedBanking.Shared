...
public static class DependencyInjectionExtensions
{
        ...
        /// <param name="source">Kafka topic</param>
        /// <returns>Same service collection</returns>
        public static IServiceCollection AddKafkaProducer<T>(this IServiceCollection services, KafkaTopicSource source)
        {
        ...
        public static IServiceCollection AddKafkaConsumer<TKey, TValue>(this IServiceCollection services, KafkaTopicSource source)
        {
